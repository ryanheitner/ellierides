...
/**
 * // this allows me to know when the animation has ended and do something
 ...
 * @author Benedict Lau
 */
abstract class AnimationDrawableCallback implements Drawable.Callback {
     ...
     */
    private final Drawable.Callback mWrappedCallback;
